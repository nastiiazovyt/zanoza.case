<div class="stage__title-block stage__title-block_seo">
    <div class="stage__title">SEO и маркетинг</div>
    <div class="stage__block_desc-row">
        <div class="stage__desc">
            <p>Текст про то, что СЕО оптимизация - важный инструмент от которого тупо  отказываться.  (Зачем тебе крутой сайт, если  его никто не увидит?)</p>
            <p>Текст про маркетинг, который помогает лучше узнать свой бизнес (группы ЦА, бренд-чемпион и тд) и транслурет без искажений идеи и смыслы бизнеса.</p>
        </div>
